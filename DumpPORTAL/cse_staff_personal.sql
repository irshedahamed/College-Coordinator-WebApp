...
CREATE TABLE `staff_personal` (
  ...
  PRIMARY KEY (`staffid`),
  CONSTRAINT `staff_id_per` FOREIGN KEY (`staffid`) REFERENCES `login`.`staff_login_details` (`staffid`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Dump completed on 2017-11-03 12:58:48
