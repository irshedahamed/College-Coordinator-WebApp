...
--
-- Table structure for table `hourattendence`
--

DROP TABLE IF EXISTS `hourattendence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hourattendence` (
  ...
  `nine` varchar(10) DEFAULT NULL,
  KEY `rollno` (`rollno`),
  CONSTRAINT `hourattendence_ibfk_1` FOREIGN KEY (`rollno`) REFERENCES `login`.`student_login_details` (`rollno`)
...
-- Dump completed on 2017-11-03 12:58:55
