 ...
 * @author Home
 */
public class DelForms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DelForms</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DelForms at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    }catch(Exception e)
    {
        e.printStackTrace();
         ...
         e.printStackTrace();
            ...
            response.sendRedirect("admin/formmanage.jsp");
