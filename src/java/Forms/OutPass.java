...
public class OutPass {
    ...
    return "Dear Parent, Your Ward Has Been Granted Permission To Leave The Hostel On "+Find.getFormattedDate(from)+" , And He Or She Should Return On Or Before "+Find.getFormattedDate(LocalDate.parse(till).plusDays(1).toString().replace("-",""))+" ( 7 AM )";
    else
            return null;
    }
