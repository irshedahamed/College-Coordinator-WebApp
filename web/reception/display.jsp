...
try
{
                           ...
                           // Class.forName("com.mysql.jdbc.Driver").newInstance();                      
                            Connection conn=new dbcon().getConnection("sjitportal?zeroDateTimeBehavior=convertToNull");
                            
                            Statement stmt=conn.createStatement();
                            
                            ResultSet rs=stmt.executeQuery("select a.rollno,a.intime,a.outtime,b.rollno,b.name,b.mobileno from entry a,"+dept+".student_personal b where intime like '"+dateonentry+"%' and a.rollno=b.rollno");
