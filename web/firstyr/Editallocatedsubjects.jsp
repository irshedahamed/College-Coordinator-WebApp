    ...
    <body><center>
        <%
            ...
            if(id.equals("all"))
            {
                ...
                %>
                <center><h1>Department of Science & Humanities</h1></center>
                <br>
                 ...
                 while(rs1.next())
                 {
                     ...
                     String staffname = rs1.getString("staffname").toString();
                      ...
                      st1.setString(2, acyear);
                         ...
                         sql="select * from subject_allocation where staffid=0? and subtype='theory' and acyear=? and (sem like '01' or sem like '03' or sem like '05' or sem like '07')";
                      st1=con.prepareStatement(sql);
                      st1.setString(1, staffid);
                      st1.setString(2, acyear);
                      }
