...
<div class="dm3-tab"><div class="dm3-tab-inner"><center><h2>Department Notes</h2><br><br>
    ...
    String ayear = request.getParameter("ayear");
        ...
        list1.add(path);
          try {
            ...
            Connection connection1 = new dbcon(clg).getConnection(request.getParameter("dept"));
