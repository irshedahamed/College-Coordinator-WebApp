<%-- 
    Document   : updatemodeltype
    Created on : Aug 25, 2015, 11:10:53 AM
    Author     : Divya Sri
--%>
                    ...
                    <div id="header-container">
                        <div class="container clearfix">
                            ...
                            <nav id="main-nav">
                                ...
                                <li id="menu-item-764" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-115 current_page_item menu-item-778"><a href="updatemodeltype.jsp">Update Model Type</a></li>
...
<li id="menu-item-769" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-777"><a href="examuploads.jsp">Exam Uploads</a>
            ...
            <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        <center>  <form action="insertmodeltype.jsp" class="sky-form" method="post" target="_blank">
                                <header>Update Model Type</header>
                                <fieldset>					
                                    <section>
                                        <label class="input">
