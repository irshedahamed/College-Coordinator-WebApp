<%-- 
    ...
    Created on : 2 Mar, 2018, 7:21:50 PM
    Author     : irshed
--%>
            ...
            <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        ...
                        <div class="dm3-tabs-testimonials" data-autoscroll=""><div class="dm3-tabs">
                                <div class="dm3-tab"><div class="dm3-tab-inner">
                                        <center>    
                                            <form action="AnalysisReportPage.jsp" class="sky-form" method="post" target="_blank">
                                                        ...
                                                        <div id="div4">
                                                            <label class="input">
                                                                ...
                                                                <label class="select">
                                                                    ...
                                                                    <select id="examtype" name="exam">
                                                                        <option disabled selected>select</option>
                                                                        <option value="unit1">IAE1</option>
                                                                        <option value="unit2">IAE2</option>
                                                                        <option value="unit3">IAE3</option>                                                                        
                                                                        <option value="unit4">IAE4</option>
                                                                        <option value="model3">Model(IAE5)</option>
                                                                    </select>
                                                                    <i></i>
                                                                </label></label>
                                                            <br> <br>
