    ...
    <body class="home page page-id-115 page-template-default has-toolbar">
        <div id="wrapper" class="toggled">
            ...
            <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        <center>
                            <form action="${pageContext.request.contextPath}/admin/staffpasswords.jsp" class="sky-form" method="post">
                                <header>STAFF PASSWORDS</header>
                                <fieldset>					
                                    <section>
                                        <label class="input">
                        ...
                        <%
                            ...
                            Connection con = new dbcon(clg).getConnection("login");
                                            ...
                                            <%
                                               ...
                                               //22 st.setString(1, dept);
                                                ...
                                                while (rs.next()) {
                                                    ...
                                                    String name = rs.getString("tittle") + rs.getString("name").toUpperCase();
                                            %>
                                            <tr>
                                                <td><%=staffid.toUpperCase()%></td>
                                                <td><%=name%></td>
                                                <td><%=pass%></td>
                                            </tr>
                                            <%
