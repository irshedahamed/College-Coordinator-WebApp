...
<section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
            <center>
            <form action="${pageContext.request.contextPath}/admin/AddressReport.jsp" class="sky-form" method="post">
                <header>STUDENT ADDRESS</header>
    <fieldset>					
					<section>
            <label class="input">
...
<section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
        ...
        <%
           ...
           con=new dbcon().getConnection(dept);
            ...
            ResultSet rs = st.executeQuery("select rollno,name from student_personal where batch like '20"+batch+"-20%'");
            int i=-1;
            while(rs.next())
            {
                i++;
           ...
           <center>
               ...
               <div style="height: 300px;width: 500px;position:absolute;">
                <%}
                    ...
                    {%>
               <div style="height: 300px;width: 500px;position:relative;left:250px;">
                <%}%>
                <table class="bordered" style="border: 2px solid;page-break-inside: avoid;">
                
                    <tr>
                    <td style="border: none;"><center><%=name.toUpperCase()%>(<%=rollno.toUpperCase()%>)</center></td>
 
</tr>
                    <tr>
                    
                    <td style="border: none;"><center><%=father.toUpperCase()%></center></td>
             </tr>
             <tr>
                   <td style="border: none;"><center><%=door.toUpperCase()%>,<%=street.toUpperCase()%></center></td>
             
             </tr>
             
             <tr>
                   <td style="border: none;"><center><%=area.toUpperCase()%>,<%=city.toUpperCase()%></center></td>
             
             </tr>
             
             <tr>
                   <td style="border: none;"><center><%=district.toUpperCase()%>,<%=state.toUpperCase()%></center></td>
             
             </tr>
              <tr>
                   <td style="border: none;"><center>Pincode : <%=pincode.toUpperCase()%></center></td>
             
             </tr>
              <tr>
                   <td style="border: none;"><center>Mobile No:<%=mobile%></center></td>
