<%-- 
    Document   : generalsms
    Created on : 20 Oct, 2016, 12:32:32 PM
    Author     : Home
--%>
...
<li id="menu-item-764" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children menu-item-768  current-menu-item page_item page-item-115 current_page_item menu-item-778"><a href="">SMS</a>
    <ul class="sub-menu">
...
<section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
            <center><form action="SendGeneralSMS.jsp" class="sky-form" method="post" target="_blank">
    <header>GENERAL SMS</header>
    <fieldset>					
					<section>
						<label class="input">
            ...
            <label class="input">
                                                    <div align="left" size="3px"><b>Message</b></div>
