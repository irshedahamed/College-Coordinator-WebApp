...
<div id="wrapper" class="toggled">
   ...
   <li id="menu-item-777" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-777"><a href="switch.jsp">Department</a>
    ...
    <md-tabs md-dynamic-height="" md-border-bottom="">
      <md-tab label="College">
        <md-content class="md-padding">
          ...
          <%out.write(Circular.getHTMLContent(College.getAll("circular",clg)));%>
        </md-content>
      </md-tab>
        ...
        <md-content class="md-padding">
          <h1 class="md-display-2"></h1>
        <%out.write(Circular.getHTMLContent(College.getAll("event",clg)));%>
        </md-content>
      </md-tab>
    </md-tabs>
  </md-content>
