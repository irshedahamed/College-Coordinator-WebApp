...
<div id="wrapper" class="toggled">
   ...
   <li id="menu-item-777" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-777  current-menu-item page_item page-item-115 current_page_item menu-item-778"><a href="switch.jsp">Department</a>
...
<center><section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
          ...
          <section class="landing">
              ...
              <center>  <form action="${pageContext.request.contextPath}/Switcher" class="sky-form" method="post" target="_blank">
    <header>Choose Department</header>
    <fieldset>					
					<section>
