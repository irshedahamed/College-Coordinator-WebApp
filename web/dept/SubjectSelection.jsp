    ...
    <body class="home page page-id-115 page-template-default has-toolbar">
        <div id="wrapper" class="toggled">
            ...
            <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        ...
                        <center>
                            <form action="${pageContext.request.contextPath}/ElectiveUpdate" class="sky-form" method="post">
                                <header>ELECTIVE SELECTION</header>
                                <fieldset>					
                                    <section>
                                    ...
                                    <div align="left">
                                        <center><input type="submit" id="submit" value="Assign" /></center></div>
                                    <br>
                                </fieldset>
                                <br>
                            </form></center>
