    ...
    <body>
      ...
      //  Statement st=con.createStatement();
        ...
        switch(ch)
        {
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set zero=? where rollno=? and date=?");
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set one=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set two=? where rollno=? and date=?");
                    stt.setString(1, subject); 
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set three=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3,date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set four=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set five=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set six=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set seven=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set eight=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
            ...
            {
                    // sql=;
                    PreparedStatement stt=con.prepareStatement("update hourattendence set nine=? where rollno=? and date=?");
                    stt.setString(1, subject);
                    stt.setString(2, rollno);
                    stt.setString(3, date);
                    stt.executeUpdate();
