...
<%
             ...
             PreparedStatement statement = connection.prepareStatement("select * from staff_experience where staffid=?");
             statement.setString(1, username);
             ResultSet rs= statement.executeQuery();
              String edoj=null,edor=null,nameorg=null,address=null,desg=null,natwork=null;
                String filename="";
              while(rs.next())
              {
                  
                  edoj=String.valueOf(rs.getDate("edoj"));
                  edor=String.valueOf(rs.getDate("edor"));
                  nameorg=rs.getString("nameorg");
                  address=rs.getString("address");
                  desg=rs.getString("desg");
                  natwork=rs.getString("natwork");
                  filename=rs.getString("filename");
                  %> 
               
         
                  <div class="dm3-tab"><div class="dm3-tab-inner"><center><font size="5px"><% if(natwork.equals("null")){%><b>TEACHING EXPERIENCE</b><%}else{%><b>INDUSTRIAL EXPERIENCE</b><%}%></font><br><br><br>
	...
	<TR CLASS="defaultText odd-row">
           ...
           <TR CLASS="defaultText odd-row">
               <TD><b>Date Of Reliving</b></TD>
               <TD><%= edor %></TD>
           </TR>
           <% if(!natwork.equals("null")){%>
		   <TR CLASS="defaultText">
           ...
           <%}%>
           		   ...
           		   <TR CLASS="defaultText">
                               <TD colspan="2"><center><a href="../StaffExpDownload?staffid=<%=username%>&filename=<%= filename %>">Download Certificate</a></center></TD>
           </TR>
