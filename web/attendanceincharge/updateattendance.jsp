    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $("#timing1").hide();
                var result, dept, batch, sem, date, time, flag = 0;
                var i = 0;
                ...
                $(document).on('change', '#datepicker', function () {
                    ...
                    $.get("../TimingServlet", {"date": date, "batch": batch, "dept": dept}, fillresp);

                });


                var fillresp = function (data)
                {
                    result = data;
                    if (!result)
                    {
    ...
    <body class="home page page-id-115 page-template-default has-toolbar">
        <div id="wrapper" class="toggled">
                            ...
                            <nav id="main-nav">
                                <ul id="menu-main-menu" class="menu"><li id="menu-item-778" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="home.jsp">Home</a></li>
                                    ...
                                    <li id="menu-item-777" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-777"><a href="#">Update Attendance</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-812" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-812  current-menu-item page_item page-item-115 current_page_item menu-item-778"><a href="updateattendance.jsp">Mark Absentees</a>
            ...
            <section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                        <center><form id="myform" action="updateatt.jsp" class="sky-form" method="post" target="_blank">
                                ...
                                <fieldset>					
                                    ...
                                    <div align="left">
                                        <input type="submit" class="button1" id="submit"  value="Mark Absentees" />
                                        ...
                                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <input type="button" class="button1" id="submit" value="No Absentees" />
                                    </div>
                                    <br>
                                </fieldset>
                            </form></center>
