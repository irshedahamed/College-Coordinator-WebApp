<%-- 
    Document   : BasicFee
    Created on : 15 Jan, 2017, 7:15:05 PM
    Author     : Home
--%>
        ...
        <div id="wrapper" class="toggled">
            ...
            <header id="page-header"  class="fixed-header">
                ...
                <script>
                    $(document).ready(function () {
                        $(".change").on('keydown change', function () {
                            var batch = $("#batch").val();
                            var type = $(this).val();
            ...
            <center><section class="section-content section-bg" style="background-color:#f5f5f5;"><div class="container clearfix"><div class="entry-content">
                            ...
                            <section class="landing">
                                ...
                                <form class="sky-form" action="${pageContext.request.contextPath}/setFee" method="post">

                                    <header>Fee Setup</header>
                                    ...
                                    <fieldset>                  
                                        ...
                                        <input type="hidden" name="batch" id="batch" value="<%=Batch.getByYrIncharge(username,clg).getBatch()%>">
                                        <label class="select">
                                            <label class="select">
                                                <div align="left" size="3px"><b>
                                                        Type: </b></div> 
                                                <select id="type" class="change" name="type">
                                                    <option value="" >Select</option>

                                                    <%
                                                        for (String ftype : BasicFee.types) {
                                                    %>
                                        ...
                                        <label class="input"><label class="input">
                                                <div align="left" size="3px"><b>
                                                        Tution : </b></div> 
                                                <input type="input" id="tution"  name="tution" >
                                            </label> </label>
                                        ...
                                        <label class="input"><label class="input">
                                                <div align="left" size="3px"><b>
                                                        Transport : </b></div> 
                                                <input type="input" id="transport"  name="transport" >
                                            </label> </label>
                                        ...
                                        <label class="input"><label class="input">
                                                <div align="left" size="3px"><b>
                                                        Placement : </b></div> 
                                                <input type="input" id="placement"  name="placement" >
                                            </label> </label>
